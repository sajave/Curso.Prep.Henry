...
function breakStatement(numero) {
  ...
  while (vecesAumentadas < 10) {
    numeroAumentado += 2;
    vecesAumentadas += 1;
    if (numeroAumentado === vecesAumentadas) {
      return "Se interrumpió la ejecución";
      break;
    }
    arrayNuevo.push(numeroAumentado);
  }
  return arrayNuevo;
}
